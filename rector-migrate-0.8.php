...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(RenameFunctionRector::class)
        ->call('configure', [[ RenameFunctionRector::OLD_FUNCTION_TO_NEW_FUNCTION => [
            ...
            'bind_textdomain_codeset' => 'Safe\bind_textdomain_codeset',
            ...
            'curl_version' => 'Safe\curl_version',
            'date' => 'Safe\date',
            ...
            'exec' => 'Safe\exec',
            'exif_imagetype' => 'Safe\exif_imagetype',
            'exif_read_data' => 'Safe\exif_read_data',
            'exif_tagname' => 'Safe\exif_tagname',
            'exif_thumbnail' => 'Safe\exif_thumbnail',
            ...
            'getcwd' => 'Safe\getcwd',
            'gethostbyaddr' => 'Safe\gethostbyaddr',
            'gethostbynamel' => 'Safe\gethostbynamel',
            ...
            'getservbyname' => 'Safe\getservbyname',
            ...
            'iconv_mime_decode_headers' => 'Safe\iconv_mime_decode_headers',
            'iconv_mime_encode' => 'Safe\iconv_mime_encode',
            'iconv_set_encoding' => 'Safe\iconv_set_encoding',
            'iconv_strlen' => 'Safe\iconv_strlen',
            'iconv_strpos' => 'Safe\iconv_strpos',
            'iconv_strrpos' => 'Safe\iconv_strrpos',
            'iconv_substr' => 'Safe\iconv_substr',
            'idate' => 'Safe\idate',
            ...
            'imap_get_quota' => 'Safe\imap_get_quota',
            'imap_get_quotaroot' => 'Safe\imap_get_quotaroot',
            'imap_headerinfo' => 'Safe\imap_headerinfo',
            'imap_headers' => 'Safe\imap_headers',
            'imap_last_error' => 'Safe\imap_last_error',
            'imap_list' => 'Safe\imap_list',
            ...
            'ldap_exop_refresh' => 'Safe\ldap_exop_refresh',
            ...
            'ldap_first_reference' => 'Safe\ldap_first_reference',
            ...
            'ldap_next_entry' => 'Safe\ldap_next_entry',
            'ldap_next_reference' => 'Safe\ldap_next_reference',
            ...
            'mb_detect_encoding' => 'Safe\mb_detect_encoding',
            ...
            'mb_ereg_search_pos' => 'Safe\mb_ereg_search_pos',
            'mb_ereg_search_regs' => 'Safe\mb_ereg_search_regs',
            'mb_ereg_search_setpos' => 'Safe\mb_ereg_search_setpos',
            'mb_get_info' => 'Safe\mb_get_info',
            'mb_http_input' => 'Safe\mb_http_input',
            'mb_http_output' => 'Safe\mb_http_output',
            'mb_internal_encoding' => 'Safe\mb_internal_encoding',
            'mb_ord' => 'Safe\mb_ord',
            'mb_parse_str' => 'Safe\mb_parse_str',
            'mb_preferred_mime_name' => 'Safe\mb_preferred_mime_name',
            'mb_regex_encoding' => 'Safe\mb_regex_encoding',
            'mb_send_mail' => 'Safe\mb_send_mail',
            'mb_split' => 'Safe\mb_split',
            'mb_stripos' => 'Safe\mb_stripos',
            'mb_stristr' => 'Safe\mb_stristr',
            'mb_strpos' => 'Safe\mb_strpos',
            'mb_strrchr' => 'Safe\mb_strrchr',
            'mb_strrichr' => 'Safe\mb_strrichr',
            'mb_strripos' => 'Safe\mb_strripos',
            'mb_strrpos' => 'Safe\mb_strrpos',
            'mb_strstr' => 'Safe\mb_strstr',
            ...
            'ob_get_contents' => 'Safe\ob_get_contents',
            'ob_get_flush' => 'Safe\ob_get_flush',
            'ob_get_length' => 'Safe\ob_get_length',
            ...
            'odbc_fetch_array' => 'Safe\odbc_fetch_array',
            'odbc_fetch_into' => 'Safe\odbc_fetch_into',
            'odbc_fetch_object' => 'Safe\odbc_fetch_object',
            ...
            'opcache_get_configuration' => 'Safe\opcache_get_configuration',
            ...
            'openssl_error_string' => 'Safe\openssl_error_string',
            ...
            'openssl_x509_parse' => 'Safe\openssl_x509_parse',
            ...
            'php_ini_loaded_file' => 'Safe\php_ini_loaded_file',
            'php_ini_scanned_files' => 'Safe\php_ini_scanned_files',
            'php_sapi_name' => 'Safe\php_sapi_name',
            'png2wbmp' => 'Safe\png2wbmp',
            'popen' => 'Safe\popen',
            'posix_access' => 'Safe\posix_access',
            'posix_ctermid' => 'Safe\posix_ctermid',
            'posix_getcwd' => 'Safe\posix_getcwd',
            ...
            'posix_getpwnam' => 'Safe\posix_getpwnam',
            ...
            'posix_ttyname' => 'Safe\posix_ttyname',
            ...
            'pspell_suggest' => 'Safe\pspell_suggest',
            ...
            'socket_recv' => 'Safe\socket_recv',
            'socket_recvfrom' => 'Safe\socket_recvfrom',
            'socket_recvmsg' => 'Safe\socket_recvmsg',
            'socket_select' => 'Safe\socket_select',
            ...
            'sodium_crypto_secretstream_xchacha20poly1305_pull' => 'Safe\sodium_crypto_secretstream_xchacha20poly1305_pull',
            ...
            'stristr' => 'Safe\stristr',
            'strpbrk' => 'Safe\strpbrk',
            'strptime' => 'Safe\strptime',
            'strrchr' => 'Safe\strrchr',
            'strstr' => 'Safe\strstr',
            ...
            'zip_open' => 'Safe\zip_open',
            'zip_read' => 'Safe\zip_read',
            'zlib_decode' => 'Safe\zlib_decode',
            'zlib_encode' => 'Safe\zlib_encode',
            'zlib_get_coding_type' => 'Safe\zlib_get_coding_type',
]]]);
};
